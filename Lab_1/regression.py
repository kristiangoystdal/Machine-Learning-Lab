...
print("Initial CoD (ridge): ", calculateCoefficientOfDetermination(y_train, y_train_pred_ridge))
prediction_errors_ridge = y_train - y_train_pred_ridge

y_train_pred_lasso = lasso.predict(x_train_standardized)
print("Initial CoD (lasso): ", calculateCoefficientOfDetermination(y_train, y_train_pred_lasso))
...
x_train_split_ridge, x_val_split_ridge, y_train_split_ridge, y_val_split_ridge = train_test_split(x_train_cleaned_ridge, y_train_cleaned_ridge, test_size=0.2, random_state=42)

x_train_split_lasso, x_val_split_lasso, y_train_split_lasso, y_val_split_lasso = train_test_split(x_train_cleaned_lasso, y_train_cleaned_lasso, test_size=0.2, random_state=42)
...
print("Improved CoD (ridge): ", calculateCoefficientOfDetermination(y_val_split_ridge, y_val_pred_ridge))
validation_errors = y_val_split_ridge - y_val_pred_ridge

y_val_pred_lasso = lasso.predict(x_val_split_lasso)
print("Improved CoD (lasso): ", calculateCoefficientOfDetermination(y_val_split_lasso, y_val_pred_lasso))
